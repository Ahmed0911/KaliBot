...
void EtherDriver::Init()
{
	...
	pucMACAddress[3] = 0xE0;
	pucMACAddress[4] = 0xC0;
	pucMACAddress[5] = 0x10;


	// lwIP Ethernet
	lwIPInit(g_ui32SysClock, pucMACAddress, inet_addr("210.0.168.192"), inet_addr("0.255.255.255"), inet_addr("1.0.168.192"), IPADDR_USE_STATIC); 	// Set IP
	...
	LocatorAppTitleSet("ESC-X2 Board");
